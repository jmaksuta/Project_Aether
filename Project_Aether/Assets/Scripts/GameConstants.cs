...
public static class GameConstants
{
    ...
    public const ushort ConnectionPort = 5000;// 7777; // Default port for server connections   
    ...
    public const string MAIN_MENU_SCENE_NAME = "02_MainMenu";
    public const string FOREST_ZONE_SCENE_NAME = "02_ForestZone";
    public const string DUNGEON_ZONE_SCENE_NAME = "03_DungeonZone";

    public const string CHARACTER_CREATION_SCENE_NAME = "02_CharacterCreation";

    // Default connection port for Netcode's Unity Transport for direct connections
    public const string GAME_SERVER_IP_ADDRESS = "192.168.1.147"; // "192.168.1.21"; // Ensure this matches your dedicated server's open port
    public const ushort GAME_SERVER_PORT = 55000; // Ensure this matches your dedicated server's open port
    
    public const string FALLBACK_LOCAL_IP_ADDRESS = "127.0.0.1"; // For local testing of direct connect
    public const ushort FALLBACK_CONNECTION_PORT = 55000;
