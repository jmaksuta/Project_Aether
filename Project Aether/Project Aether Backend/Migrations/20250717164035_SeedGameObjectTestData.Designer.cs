...
namespace Project_Aether_Backend.Migrations
{
    ...
    [Migration("20250717164035_SeedGameObjectTestData")]
    partial class SeedGameObjectTestData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectAether.Objects.Net._2._1.Standard.Models.GameObject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Test Object",
                            ObjectType = "NonPlayerCharacter",
                            PrefabConfigData = "{\"Color\":\"Red\",\"Diameter\":0.25,\"InteractionMessage\":\"You have interacted with the test sphere.\"}",
